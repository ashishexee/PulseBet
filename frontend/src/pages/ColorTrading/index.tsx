...
const COLOR_TRADING_RULES = (
    <div className="space-y-4">
        <div className="space-y-2">
            <h4 className="text-white font-bold text-sm uppercase tracking-wider">Game Objective</h4>
            <p className="text-zinc-400 text-sm leading-relaxed">
                Predict the winning color generated by the autonomous probability engine. Each color carries a specific multiplier and probability weight.
            </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-3">
            <div className="p-3 bg-zinc-950/50 rounded-lg border border-zinc-800 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-white font-bold text-xs uppercase">Safe Zone</span>
                </div>
                <div className="text-right">
                    <span className="block text-emerald-500 font-mono font-bold">3.0x Yield</span>
                    <span className="block text-zinc-500 text-[10px] font-bold">30% Chance</span>
                </div>
            </div>
            ...
            <div className="p-3 bg-zinc-950/50 rounded-lg border border-zinc-800 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-white font-bold text-xs uppercase">Risk Zone</span>
                </div>
                <div className="text-right">
                    <span className="block text-amber-500 font-mono font-bold">6.0x Yield</span>
                    <span className="block text-zinc-500 text-[10px] font-bold">15% Chance</span>
                </div>
            </div>
            ...
            <div className="p-3 bg-zinc-950/50 rounded-lg border border-zinc-800 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-white font-bold text-xs uppercase">High Stakes</span>
                </div>
                <div className="text-right">
                    <span className="block text-rose-500 font-mono font-bold">9.0x Yield</span>
                    <span className="block text-zinc-500 text-[10px] font-bold">10% Chance</span>
                </div>
            </div>
        </div>
        ...
        <div className="space-y-2 pt-2 border-t border-zinc-800">
            ...
            <ul className="list-disc pl-4 space-y-1 text-zinc-400 text-sm marker:text-zinc-600">
                <li>Wait for the <strong>Bidding Interval</strong> to open.</li>
                <li>Select a color strategy and place your PT amount.</li>
                <li>Winners are paid out immediately from the liquidity pool.</li>
            </ul>
        </div>
    </div>
);
        ...
        return (
            <>
                <GameOverlay
                    ...
                    connect={connect}
                    gameId="color_trading"
                    gameTitle="Color Trading"
                    rules={COLOR_TRADING_RULES}
                />
                <div className="fixed inset-0 bg-zinc-950/90 backdrop-blur-md z-40 flex flex-col items-center justify-center">
