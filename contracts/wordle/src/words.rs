pub const WORDS: [&str; 1000] = [
    ...
    "BONUS", "BOOBY", "BOOST", "BOOTH", "BOOTY", "BOOZE", "BOOZY", "BORAX", "BOREK", "BORNE",
    "BOSOM", "BOTCH", "BOUGH", "BOULE", "BOUND", "BOWEL", "BOXER", "BRACE", "BRAID", "BRAIN",
    ...
    "CLING", "CLOCK", "CLONE", "CLOSE", "CLOTH", "CLOUD", "CLOUT", "CLOVE", "CLOWN", "CLUBB",
    "CLUCK", "CLUED", "CLUMP", "CLUNG", "COACH", "COAST", "COBRA", "COCOA", "COHER", "COILS",
    "COINS", "COLIC", "COLON", "COLOR", "COMET", "COMFY", "COMIC", "COMMA", "CONCH", "CONDO",
    ...
    "FIGHT", "FILER", "FILET", "FILMY", "FILTH", "FINAL", "FINCH", "FINER", "FIRST", "FISHY",
    ...
    "GAYLY", "GAZER", "GECKO", "GEESE", "GENIE", "GENRE", "GHOST", "GHOUL", "GIANT", "GIDDY",
    ...
    "GUILE", "GUILT", "GUISE", "GULCH", "GULLY", "GUMMY", "GUSTO", "GUSTY", "GYPSY", "HABIT",
    ...
    "HOMER", "HONEY", "HONOR", "HOPED", "HOPES", "HORDE", "HORNY", "HORSE", "HOTEL", "HOTLY",
